...
LEGAL_CONCEPTS: dict[str, list[str]] = {
    "jurisdiction":       ["jurisdiction", "locus standi", "competence of court", "standing to sue",
                           "subject matter jurisdiction", "territorial jurisdiction"],
    "estoppel":           ["estoppel", "res judicata", "issue estoppel", "cause of action estoppel",
                           "collateral estoppel", "estoppel per rem judicatam"],
    "contempt":           ["contempt of court", "disobey order", "breach of court order",
                           "committal for contempt"],
    "limitation":         ["limitation of action", "statute of limitations", "time-barred",
                           "limitation period", "prescription"],
    "natural_justice":    ["natural justice", "fair hearing", "audi alteram partem",
                           "nemo judex in causa sua", "bias", "opportunity to be heard"],
    "contract":           ["contract", "breach of contract", "offer and acceptance", "consideration",
                           "misrepresentation", "frustration of contract", "privity"],
    "evidence":           ["admissibility", "hearsay", "documentary evidence", "burden of proof",
                           "standard of proof", "confessional statement", "circumstantial evidence"],
    "injunction":         ["injunction", "interlocutory injunction", "mareva injunction",
                           "mandatory injunction", "restraining order", "status quo"],
    "appeal":             ["ground of appeal", "leave to appeal", "notice of appeal",
                           "competent appeal", "right of appeal", "appellate jurisdiction"],
    "criminal":           ["mens rea", "actus reus", "criminal intent", "reasonable doubt",
                           "prosecution", "acquittal", "conviction", "sentence"],
    "land":               ["land law", "title to land", "trespass", "adverse possession",
                           "customary land", "certificate of occupancy", "right of occupancy"],
    "company":            ["company law", "corporate veil", "shareholder", "director",
                           "winding up", "insolvency", "memorandum of association"],
    "constitutional":     ["fundamental rights", "constitutional right", "section 33", "section 34",
                           "section 35", "section 36", "section 41", "section 42",
                           "constitutional validity", "unconstitutional"],
    "tort":               ["negligence", "duty of care", "tortious liability", "defamation",
                           "libel", "slander", "nuisance", "trespass to person"],
    "election":           ["election petition", "electoral malpractice", "pre-election matter",
                           "governorship election", "senatorial", "house of representatives"],
    ...
    "administrative":     ["administrative action", "judicial review", "certiorari", "mandamus",
                           "prohibition", "public body", "ultra vires"],
    "enforcement":        ["enforcement of judgment", "garnishee", "writ of execution", "attachment"],
    "damages":            ["damages", "quantum of damages", "special damages", "general damages",
                           "exemplary damages", "punitive damages", "loss of earnings"],
    "service":            ["service of process", "substituted service", "originating process",
                           "writ of summons"],
    "costs":              ["costs", "security for costs", "award of costs", "taxation of costs"],
    "interlocutory":      ["interlocutory", "interim", "pending trial", "balance of convenience",
                           "irreparable damage", "status quo ante"],
    ...
    "striking_out":       ["strike out", "struck out", "no reasonable cause of action",
                           "abuse of process", "frivolous", "vexatious"],
    "stay":               ["stay of proceedings", "stay of execution", "pending appeal",
                           "suspension of judgment"],
    "summary_judgment":   ["summary judgment", "undefended list", "judgment on the pleadings",
                           "no defence", "admitted facts"],
}
...
MOTION_KEYWORDS: dict[str, list[str]] = {
    "motion_to_dismiss": [
        "dismiss", "struck out", "strike out", "no cause of action",
        "abuse of process", "frivolous", "vexatious", "no locus standi",
        "want of jurisdiction", "incompetent suit",
    ],
    "interlocutory_injunction": [
        "injunction", "restrain", "interim order", "interlocutory relief",
        "balance of convenience", "irreparable damage", "status quo",
        "mareva", "anton piller",
    ],
    "stay_of_proceedings": [
        "stay of proceedings", "stay of execution", "pending appeal",
        "suspend", "halt proceedings", "adjourn sine die",
    ],
    "summary_judgment": [
        "summary judgment", "undefended list", "judgment on the pleadings",
        "no triable issue", "no defence disclosed",
    ],
    "extension_of_time": [
        "extension of time", "time limit", "out of time", "enlarge time",
        "time within which", "appeal out of time", "regularise",
    ],
}
